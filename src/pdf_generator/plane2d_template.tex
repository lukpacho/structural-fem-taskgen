...
\begin{center}
    ...
    Konstrukcja ma grubość $t = \VAR{t}$\,\BLOCK{ if t|int >= 1000 }$\si{m}$  \BLOCK{ else }$\si{mm}$ \BLOCK{ endif } i wykonano ją z materiału o parametrach $E = \VAR{E}$\,$\si{GPa}$ oraz $\nu = \VAR{nu}$. \\
    ...
    \item Wyniki przemieszczeń i naprężeń dla obu wariantów w tabeli poniżej (uzupełnij jednostki) \dotfill 5 pkt
    \begin{table}[ht]
        \centering
