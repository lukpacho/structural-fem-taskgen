...
from src.solver.plane2d_solver import (solve_plane2d, build_plane2d_with_predefined_mesh, build_plane2d_with_auto_mesh,
                                       load_plane2d_configuration, save_plane2d_input_and_results,
                                       find_displacement_at_predefined_nodes_in_auto_mesh, edofs_to_enodes)
...
from src.solver.plane2d_plotter import plot_plane2d_stresses, plot_plane2d_displacement
    ...
    if mode == 'random':
        for simulation_index in range(num_simulations):
            ...
            automesh_corresponding_displacements = find_displacement_at_predefined_nodes_in_auto_mesh(
                coords, result_summary, coords_auto, dofs_auto, a_auto, )
            ...
            if generate_pdf:
                data = prepare_plane2d_data_for_latex(
                    ...
                    boundary_conditions, forces, mesh_props, result_summary
                )
